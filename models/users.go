...
var UserWhere = struct {
	...
	CreateAt:  whereHelpernull_Time{field: "\"users\".\"create_at\""},
	UpdateAt:  whereHelpernull_Time{field: "\"users\".\"update_at\""},
}
...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "create_at", "update_at"}
	userColumnsWithoutDefault = []string{"id"}
	userColumnsWithDefault    = []string{"first_name", "last_name", "create_at", "update_at"}
